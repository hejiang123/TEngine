...
namespace FairyGUI
{
    ...
    public class UIObjectFactory
    {
        ...
        public delegate GComponent GComponentDelegate(string url);
        ...
        private static UIObjectFactory.GComponentDelegate defaultComponentDelegate;
        public static void SetDefaultPackageItemExtension(UIObjectFactory.GComponentDelegate creator)
        {
            UIObjectFactory.defaultComponentDelegate = creator;
        }
        ...
        public static GObject NewObject(PackageItem pi, System.Type userClass = null)
        {
            ...
            {
                if (UIObjectFactory.defaultComponentDelegate != null)
                    obj = (GObject) UIObjectFactory.defaultComponentDelegate("ui://" + pi.owner.id + pi.id);
                if(null == obj)
                {
                    if (userClass != null)
                    {
